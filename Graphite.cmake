...
function(fonttest TESTNAME FONTFILE)
    ...
    if (NOT (GRAPHITE2_NSEGCACHE OR GRAPHITE2_NFILEFACE))
        add_test(NAME ${TESTNAME} COMMAND $<TARGET_FILE:gr2fonttest> -dpi 0 -trace ${PROJECT_BINARY_DIR}/${TESTNAME}.json -log ${PROJECT_BINARY_DIR}/${TESTNAME}.log ${PROJECT_SOURCE_DIR}/fonts/${FONTFILE} -codes ${ARGN})
