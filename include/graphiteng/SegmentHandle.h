...
public:
    SegmentHandle(const LoadedFont* font, const LoadedFace* face, uint32 script, SegmentHandle::encform enc, const void* pStart, size_t nChars, int dir);
    SegmentHandle(const LoadedFont* font, const LoadedFace* face, uint32 script, const FeaturesHandle& pFeats, SegmentHandle::encform enc, const void* pStart, size_t nChars, int dir);
...
private:
    void initialize(const LoadedFont* font, const LoadedFace* face, uint32 script, const FeaturesHandle& pFeats, SegmentHandle::encform enc, const void* pStart, size_t nChars, int dir);
