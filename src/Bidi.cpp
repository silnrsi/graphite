...
inline bool     IsDeferredState(bidi_state a)           { return bool((1 << a) & (rtmask | ltmask | acmask | rcmask | rsmask | lcmask | lsmask)); }
inline bool     IsModifiedClass(DirCode a)              { return bool((1 << a) & (ALmask | NSMmask | ESmask | CSmask | ETmask | ENmask)); }
