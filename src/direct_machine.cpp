                            ...
                            const int       islot_idx)
{
    ...
    // the stack and cause no damage this condition will them be caught
    // check_stack.
...
{
    return static_cast<const opcode_t *>(direct_machine(true, constraint, 0, 0, 0, 0, 0));
}
                     ...
                     const int      islot_idx)
{
    ...
    const void * ret = direct_machine(false, false, program,
