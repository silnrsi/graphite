...
private:
    ...
    uint8_t    m_bits,             // how many bits to shift the value into place
...
public:
    ...
    //GrFeatureRef *featureRef(uint8_t index) { return index < m_numFeats ? m_feats + index : NULL; }
    const FeatureRef *featureRef(uint8_t index) const { return index < m_numFeats ? m_feats + index : NULL; }
