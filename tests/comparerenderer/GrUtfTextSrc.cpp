...
GrUtfTextSrc::~GrUtfTextSrc()
{
	...
	if (mData32) delete [] mData32;
        // We don't own the feature parser
//        mpFeatureParser = NULL;
...
{
//    if (mpFeatureParser && mpFeatureParser->hasLanguage())
//        return mpFeatureParser->getLanguage();
    gr::isocode unknown;
